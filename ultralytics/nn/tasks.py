...
from ultralytics.nn.modules.block import (
    DSC3k2, DownsampleConv, FullPAD_Tunnel, HyperACE
)
####   YOLO13

#导入PConv
from ultralytics.nn.Addmodules.PConv import PConv, C2f_PConv,Bottleneck_PConv, CSPPC, PConv_MO
# 导入slim-neck中的VOVSCSP和GSConv模块，
from ultralytics.nn.Addmodules.Slimneck import VoVGSCSP, GSConv, VoVGSCSPC, VoVGSCSPSA, GSAConv, VoVGSCSPP
# 导入slim-neckv2中模块，rethinking-fpn   Slimneckv2  GSConv的升级版
...
from ultralytics.nn.Addmodules.RFAConv import RFAConv, RFAConv_yolov8, RFAConv_G, RFA_SPDConv, RFA_SPDConv_HWD_CARAFE, \
    ...
    RFA_SPD_FCConv_HWD_ADown_CARAFE_SDI, RFA_SPD_Oct_CARAFE_HWDConv, SPDConv_Oct_CARAFE_HWD_Conv, SPDConv_Oct_CARAFE_HWD_ADown, SPDConv_FFC, SPDConv_Oct_CARAFE
    ...
    base_modules = frozenset(
        {
            ...
            SCDown,
            C2fCIB,
            PConv,VoVGSCSP, VoVGSCSPC, VoVGSCSPSA, VoVGSCSPP, GSConv, GSAConv, # 导入slim-neck中的VOVSCSP和GSConv模块
            GSConvE, GSConvE2, ESD, ESD2,  # rethinking-fpn GSConv的升级版
            RFAConv, RFAConv_yolov8, RFAConv_G, RFA_SPDConv, RFA_SPDConv_HWD_CARAFE, RFA_SPDConv_Fourier_CARAFE,
            RFA_SPDConv_Fourier, RFA_SPDConv_HWD, RFA_SPDConv_Fourier_CARAFE_SDI, RFA_SPDConv_HWD_CARAFE_SDI,
            RFA_SPDConv_Fourier_SDI, RFA_FFConv, RFA_SPDConv_FFC_ADown_CARAFE, RFA_SPDConv_OctC_CARAFE,
            RFA_SPD_FCConv, RFA_SPD_FCConv_HWD_ADown_CARAFE, RFA_SPD_FCConv_HWD_ADown_CARAFE_SDI,
            RFA_SPD_Oct_CARAFE_HWDConv,
            SPDConv_Oct_CARAFE_HWD_Conv, SPDConv_Oct_CARAFE_HWD_ADown, SPDConv_FFC, SPDConv_Oct_CARAFE,
            SAConv2d, SPPF_deformable_LKA, Efficient_SPPF,
        }
    )
    repeat_modules = frozenset(  # modules with 'repeat' arguments
        {
            ...
            C2fCIB,
            C2PSA,
            VoVGSCSP, VoVGSCSPC, VoVGSCSPSA, VoVGSCSPP,
        }
    )
    # print(globals())
